...
import { faFilter, faFileExport,  faDollarSign } from '@fortawesome/free-solid-svg-icons'
import React from "react";


const PrivateFilter = ({ filterText, onFilter, onClear }) => (
    <div className="row">
        <div className="col-12 col-md-7">
            <div className="row">
                <div className="col-12 col-md-4 tabiletitle">Private Rides</div>
        ...
        <div className="col-12 col-md-5 " >
            <div className="row ">
                ...
                <button className="btn  btn-md center-block export"><FontAwesomeIcon icon={faDollarSign} />  Price</button>
